                ...
                {CoachingExpert.map((expert, index) => (
                  ...
                  >
                    <Image
                      ...
                      width={100}
                      height={100}
                      className={`rounded-2xl h-[80px] w-[80px] object-cover hover:scale-105 transition-all cursor-pointer p-0.5 border-primary ${selectedExpert === expert.name && "border-2"}`}
                    />
